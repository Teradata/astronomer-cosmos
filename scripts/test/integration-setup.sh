...
pip uninstall -y dbt-postgres dbt-databricks dbt-vertica dbt-teradata
rm -rf airflow.*
pip freeze | grep airflow
airflow db reset -y
airflow db init
pip install 'dbt-core' 'dbt-databricks' 'dbt-postgres' 'dbt-vertica' 'dbt-teradata' 'openlineage-airflow'
